...
export default function GetStarted({ setActivePage }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (password !== confirmPassword) {
      setPasswordMismatchPopup(true);
      setTimeout(() => setPasswordMismatchPopup(false), 3000);
      return;
    }
      ...
      {passwordMismatchPopup && (
        <div className="gs-popup-overlay">
          <div className="gs-popup">
            <div className="gs-popup-icon">⚠️</div>
            <h3>Passwords do not match</h3>
            <p>Please make sure both password fields contain the same value.</p>
            <button 
